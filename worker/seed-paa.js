      ...
      subtopics: [
        {
          title: 'PAPOMUDAS',
          walkthrough: [
            { col: 'theory', type: 'write', html: '<div class="theory-line rule">PAPOMUDAS</div><div class="theory-line">Paréntesis → Potencias → Mult/Div → Suma/Resta</div>', pause: 1800, audio: 'paa-arit-n1-01.mp3' },
            { col: 'prob',   type: 'write', html: '3 + 4 × 2 − (6 ÷ 3)', pause: 2000, audio: 'paa-arit-n1-02.mp3' },
            { col: 'calc',   type: 'write', html: '<div class="calc-line"><span class="red">(6 ÷ 3)</span> = ?</div>', pause: 700, audio: 'paa-arit-n1-03.mp3' },
            { col: 'calc',   type: 'question', question: '¿cuánto es 6 ÷ 3?', hint: 'resuelve el paréntesis', answer: '2', correct: '✓ 6 ÷ 3 = <span class="hl">2</span>', wrong: '6 ÷ 3 = <span class="hl">2</span>', audio: null },
            { col: 'prob',   type: 'write', html: '3 + 4 × 2 − <span class="hl">2</span>', pause: 1400, audio: 'paa-arit-n1-04.mp3' },
            { col: 'theory', type: 'write', html: '<div class="theory-line">paréntesis ✓</div>', pause: 700, audio: null },
            { col: 'calc',   type: 'write', html: '<div class="calc-sep"></div><div class="calc-line"><span class="blu">4 × 2</span> = ?</div>', pause: 700, audio: 'paa-arit-n1-05.mp3' },
            { col: 'calc',   type: 'question', question: '¿cuánto es 4 × 2?', hint: 'multiplicación antes que suma', answer: '8', correct: '✓ 4 × 2 = <span class="hl">8</span>', wrong: '4 × 2 = <span class="hl">8</span>', audio: null },
            { col: 'prob',   type: 'write', html: '3 + <span class="hl">8</span> − 2', pause: 1400, audio: 'paa-arit-n1-06.mp3' },
            { col: 'theory', type: 'write', html: '<div class="theory-line">multiplicación ✓</div>', pause: 700, audio: null },
            { col: 'calc',   type: 'write', html: '<div class="calc-sep"></div><div class="calc-line"><span class="amb">3 + 8 − 2</span> = ?</div>', pause: 700, audio: 'paa-arit-n1-07.mp3' },
            { col: 'calc',   type: 'question', question: '¿cuánto es 3 + 8 − 2?', hint: 'de izquierda a derecha', answer: '9', correct: '✓ 3 + 8 − 2 = <span class="hl">9</span>', wrong: '3 + 8 = 11 → 11 − 2 = <span class="hl">9</span>', audio: 'paa-arit-n1-08.mp3' },
            { col: 'prob',   type: 'write', html: '<span class="hl">= 9 ✓</span>', final: true, pause: 0, audio: null },
            { col: 'theory', type: 'write', html: '<div class="theory-line">suma/resta ✓</div>', pause: 0, audio: 'paa-arit-n1-09.mp3' },
          ],
        },
      ],
      example: {
